...
public:
  ...
  class Authority {
  public:
    Authority(const boost::optional<UserInfo> &info, const Host &host,
              const boost::optional<Port> &optionalPort);
  ...
  Uri(const Scheme &scheme, const Authority &authority,
...
const std::map<Uri::Scheme, Uri::Port> DefaultPorts{
