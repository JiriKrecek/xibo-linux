...
private:
  ...
  friend DateTime operator+(const DateTime &first,
                            const DateTime::Hours &hours);
  friend DateTime operator+(const DateTime &first,
                            const DateTime::Minutes &mins);
  friend DateTime operator+(const DateTime &first,
                            const DateTime::Seconds &secs);
  friend DateTime::Time operator-(const DateTime &first,
